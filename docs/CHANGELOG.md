...
- 将复杂多问论文的 F01 从“六层简单框图”升级为**论文专属完整框架图**：优先接入 `paper-framework-figure-studio-pro`，要求真实数据/结果锚点、各问内部机制、跨问关系、验证反馈与独立测试边界；YAML 路线图降为语义草图、低复杂度充分表达或后备。
...
- 固化每张图的“图前定位—图注解码—图后证据解释—边界/转折”叙述合同，并更新 T05/T06 自检项。
