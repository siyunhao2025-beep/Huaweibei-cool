...
- 修复 CI 与新增 PDF 集成测试的环境错配：Ubuntu 显式安装 XeLaTeX、CTeX、`ulem`、Fandol、TeX Gyre 正文/数学字体及所需 LaTeX 包，并在测试前逐项检查关键样式与字体；标题字体回退改用 TeX 树内 OTF 文件名，避免最小 Linux runner 未把 Fandol 注册进 fontconfig。两轮修正后本机全量回归更新为 375 passed、0 skipped/xfail/xpass。
