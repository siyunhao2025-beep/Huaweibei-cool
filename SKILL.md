---
name: huawei-mcm
description: 华为杯（中国研究生数学建模竞赛）国一母 Skill。覆盖赛前训练、比赛日全流程、单题卡点求助、论文打磨、赛后蒸馏五类场景。当用户要准备或参加华为杯研赛、需要按获奖论文范式建模/求解/写论文、或要对一道赛题做方法选型与论文成稿时触发。不用于普通课程作业、非数学建模的科研论文、或纯绘图需求（绘图走 academic-figure 子 skill）。
---
