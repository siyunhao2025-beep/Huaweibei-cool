...
| P4 | 论文初稿 | 摘要/正文/结论、用户篇幅裁决 | 章节齐、每个编号问题有“回溯—路线—交付”开篇导读、摘要一般不超过2页、用户已选择总页数或“证据充分即可”、计算型附录的伪代码—脚本—结果映射闭合（或已记录不适用理由）、自检表文件就位 |
