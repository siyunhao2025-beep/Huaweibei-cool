...
| **Semantic richness > arbitrary color abundance** | Use 2–4 semantic main colors + 1 accent per Figure; vary justified palette roles across the paper and never use matplotlib/ggplot defaults |
...
```text
    ...
    │   ├── eval_runner.py             ← Full asset audit (39 asset families auto-scan)
